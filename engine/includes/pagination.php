            ...
            if ( $this->count_pages > 1) {
                ...
                for ($i = $this->start; $i <= $this->end; $i++) {                    
                    if ($i == $this->active){
                        ...
                        $pages .= '<a href="#" onclick="list_submit('.($i == 1? '' : $i).'); return(false);">'.$i.'</a>';
                    }
                }
                ...
                $tpl->save('navigation', 'navigation', [
                    ...
                    'next-links' => $this->active < $this->count_pages,
                    'first-page' => '',
                    'prev-page' => $this->active == 2? '' : $this->active - 1,
                    'next-page' => $this->active + 1,
                    'last-page'=> $this->count_pages,
                    'pages' => $pages,
                ]);
